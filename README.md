...
- New accounts are guided to **The parlor** after choosing a name. Save the generated recovery code in a password manager and choose whether this is a trusted personal device. There is no separate messaging password to create. Then select a friend and send a note.
